...
// default로 내보내도 다른이름으로 받을 수 없고 꼭 store로 받아짐
    // 1) 데이터 세팅구역
    state:{
        // 도시 데이터 셋업
        cityData:{
            ...
            "광주":{
                이미지:`https://i.ytimg.com/vi/HVLiTRy9KKY/maxresdefault.jpg`,
                설명:`대한민국의 광역시. 전라남도에 둘러싸여 있다. 전라도의 최대도시이며 광주권의 수부도시다. 광주학생항일운동의 도화선이었고 4.19 혁명, 5.18 민주화운동, 6.10 민주 항쟁이 일어나는 등 한국 근현대사에 굵은 획을 남긴 도시다.`
            }
        },// cityData
        // 이미지 정보 셋업변수: 화면에 반영 될 이미지
        imgSrc:'',
        // 도시 설명 정보 셋업변수 : 화면에 반영 될 설명
        desc:'',
    },
    // 2) 데이터 변경 메서드 구역
    // -> 컴포넌트에서 호출 시 commit() 사용
    mutations:{
        // 초기 데이터 셋업 메서드
        initSet(헐,파라미터){
            // 전달변수는 파라미터에 담김
